class TermsController < ApplicationController
  ...
  def index
    @terms = Term.search(params[:search]).order("name ASC")
  end
  ...
  # GET /terms/1/edit
  def edit
    @term.definitions.build unless @term.definitions.present?
  ...
  private
    ...
    def term_params
      params.require(:term).permit(:name, :short_form, definitions_attributes: [:id, :description, :source_name, :source_url, :_destroy])
    end
end
