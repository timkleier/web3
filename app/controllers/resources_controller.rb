class ResourcesController < ApplicationController
  ...
  def create
    @resource = create_resource(resource_params)
  ...
  private
    ...
    def create_resource(params)
       resource_params[:url] && !resource_params[:url].empty? ? Resource.create_from_url(resource_params[:url]) : Resource.new(resource_params)
    end
end
